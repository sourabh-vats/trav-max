    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Welcome to Wedding Lodges
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Thank you for signing up with weddinglodges.com! We hope you enjoy your time with us. 
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="http://weddinglodges.com/signin.php"
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Wedding Lodges</strong><br />
              <a href="https://weddinglodges.com">weddinglodges.com</a> <br />
            </td>
          </tr>
        </table>
      </center>
