...
<div class="row d-flex justify-content-center flex-wrap">
    ...
    <h2 class="text-center">You have selected <?php echo $package_data[0]['display_name']; ?> Package for Rs. <?php echo $package_data[0]['total']; ?> <?php if ($booking_packages_number > 1) {
