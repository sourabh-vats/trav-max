        ...
        <div class="row mb-4 gradient_parent">
            <div class="col text-center py-4">
                <!-- <a href="/admin/travelcenter"> -->
                    <h3 class="d-flex align-items-start justify-content-center">MONEYBACK &nbsp;<i class="bi bi-info-circle" style="font-size:12px" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="This top tooltip is themed via CSS variables."></i></h3>
                    <span class="box_number_data">₹<?php echo round($wallet["moneyback"], 0); ?></span>
                <!-- </a> -->
            </div>
            <div class="col text-center py-4">
                <!-- <a href="/admin/businesscenter"> -->
                    <h3 class="d-flex align-items-start justify-content-center">CASHBACK &nbsp;<i class="bi bi-info-circle" style="font-size:12px" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="This top tooltip is themed via CSS variables."></i></h3>
